...
TORCH_COMPATIBLE_QTYPES = (None, gguf_np.GGMLQuantizationType.F32, gguf_np.GGMLQuantizationType.F16)
...
def dequantize_tensor(tensor, dtype=None, dequant_dtype=None):
    ...
    if qtype in TORCH_COMPATIBLE_QTYPES:
        ...
        new = gguf_np.dequantize(tensor.cpu().numpy(), qtype)
...
def dequantize(data, qtype, oshape, dtype=None):
    ...
    """
    block_size, type_size = gguf_np.GGML_QUANT_SIZES[qtype]
...
dequantize_functions = {
    ...
    gguf_np.GGMLQuantizationType.Q4_1: dequantize_blocks_Q4_1,
    gguf_np.GGMLQuantizationType.Q4_0: dequantize_blocks_Q4_0,
    gguf_np.GGMLQuantizationType.Q6_K: dequantize_blocks_Q6_K,
    gguf_np.GGMLQuantizationType.Q5_K: dequantize_blocks_Q5_K,
    gguf_np.GGMLQuantizationType.Q4_K: dequantize_blocks_Q4_K,
    gguf_np.GGMLQuantizationType.Q3_K: dequantize_blocks_Q3_K,
